...
- **Archivo is a substitution.** The 4OURTY wordmark's real typeface was never
  supplied; Archivo at `wdth` 125% is a considered match, not the original.
  Naming the real face changes one line in the `@theme` block.
